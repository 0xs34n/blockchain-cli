...
test('#handleBlockchainResponse :: shorter blockchain', t => {
 // blockchain.persistence.clearBlocks();
  //blockchain.persistence.insertBlocks({})
  const newChain = JSON.stringify([new Block(444), new Block(555)])
  //blockchain.a = { index: 9 }
...
//  const newChain = JSON.stringify([block])
//  const nextBlock = new Block(2223)
//  p2p.handleBlockchainResponse({ data: newChain })
//  t.is(blockchain, nextBlock)
//})
